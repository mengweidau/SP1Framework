...
//const int maxQuestionNum = 6;
//
//for ((*_fairy).currentQuestionNum = 0; (*_fairy).currentQuestionNum < maxQuestionNum;) //set the answers for each questions 
//{
//	if ((*_fairy).currentQuestionNum == 0)//question 1
//	{
//		(*_fairy).question[(*_fairy).currentQuestionNum] = "How many Facebook friends does PRIDE have…?";
//		(*_fairy).ans[0] = "1. 39648";
//		(*_fairy).ans[1] = "2. 36948";
